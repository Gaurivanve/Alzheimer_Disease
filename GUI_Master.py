...
label_l1 = tk.Label(root, text="Alzheimer Disease detection", font=("times new roman", 35, 'bold'),
                    background="green", fg="white", width=35, height=0)
...
button1 = tk.Button(root, text="Alzheimer Disease detection", command=log,
                    height=1, font=('times', 20, ' bold '), bg="black", fg="white")
button1.place(x=800, y=40)
...
button3 = tk.Button(root, text="Exit", command=window, width=14,
                    height=1, font=('times', 20, ' bold '), bg="red", fg="white")
button3.place(x=1160, y=40)
